...
## video_recorder (noetic) - 0.1.1-1

The packages in the `video_recorder` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -t noetic -r noetic video_recorder` on `Mon, 03 Jun 2024 18:18:37 -0000`
...
## video_recorder (noetic) - 0.1.0-1

The packages in the `video_recorder` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -t noetic -r noetic video_recorder` on `Mon, 27 May 2024 18:42:33 -0000`
...
## video_recorder (noetic) - 0.0.10-1

The packages in the `video_recorder` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -t noetic -r noetic video_recorder` on `Thu, 04 Jan 2024 15:43:31 -0000`
...
## video_recorder (noetic) - 0.0.9-1

The packages in the `video_recorder` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -t noetic -r noetic video_recorder` on `Thu, 07 Sep 2023 20:41:09 -0000`
...
## video_recorder (noetic) - 0.0.8-1

The packages in the `video_recorder` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -t noetic -r noetic video_recorder` on `Wed, 23 Aug 2023 13:55:00 -0000`
...
## video_recorder (noetic) - 0.0.7-1

The packages in the `video_recorder` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -t noetic -r noetic video_recorder` on `Wed, 23 Aug 2023 13:11:34 -0000`
...
## video_recorder (noetic) - 0.0.6-1

The packages in the `video_recorder` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -t noetic -r noetic video_recorder` on `Wed, 16 Aug 2023 15:34:29 -0000`
